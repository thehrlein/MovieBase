...
public class AdditionalMovieInfoDelegate extends AdapterDelegate<List<DisplayableItem>> {
    ...
    public AdditionalMovieInfoDelegate(Context context) {
    ...
    protected RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent) {
        return new AdditionalMovieInfoViewHolder(LayoutInflater.from(context).inflate(R.layout.detail_additional_movie_info_holder, parent, false), context);
    }
