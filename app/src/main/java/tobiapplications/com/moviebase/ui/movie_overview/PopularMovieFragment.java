...
public class PopularMovieFragment extends Fragment implements MovieOverviewFragmentContract.View {
    private final String TAG = PopularMovieFragment.class.getSimpleName();
